  ...
  module Book
    module Model
      class Product < SubsetDsl
        ...
        include Onix::Book::ProductSuppliesExtractor
        ...
        def raw_file_description
          if @descriptive_detail.file_description
            Onix::Book::Tools::Global.strip_html(@descriptive_detail.file_description).gsub(/\s+/," ").strip
          else
            nil
          end
        end
        ...
        def raw_description
          if self.description
            Onix::Book::Tools::Global.strip_html(self.description).gsub(/\s+/," ").strip
          else
            nil
          end
        end
