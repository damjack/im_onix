    ...
    class Entity < Base
      ...
      def parse(n)
        ...
        n.children.each do |t|
          case t
            when Onixo::Helpers::Matcher.new(self.class.name_tag)
              @name=t.text
            when Onixo::Helpers::Matcher.new(self.class.role_tag)
              if self.class.role_class
                @role=self.class.role_class.new().parse(t)
              end
            when Onixo::Helpers::Matcher.new(self.class.identifier_tag)
